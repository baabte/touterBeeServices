...
urlpatterns = patterns('',
    ...
    url(r'^FnCheckEmailExists/$', 'myapp.views.FnCheckEmailExists', name='FnCheckEmailExists'),
    url(r'^FnCompanySignup/$', 'myapp.views.FnCompanySignup', name='FnCompanySignup'),
    url(r'^FnCheckCompanyNameExists/$', 'myapp.views.FnCheckCompanyNameExists', name='FnCheckCompanyNameExists'),
