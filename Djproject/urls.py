...
urlpatterns = patterns('',
    ...
    url(r'^FnUserSignup/$', 'myapp.signup.FnUserSignup', name='FnUserSignup'),  #by Akshath
    url(r'^FnCheckEmailExists/$', 'myapp.signup.FnCheckEmailExists', name='FnCheckEmailExists'),
    url(r'^activate/(?P<key>.+)$','myapp.signup.activation', name='activation'),
    url(r'^FnLoadTBeeConfig/$', 'myapp.SocialConfiguration.FnLoadTBeeConfig', name='FnLoadTBeeConfig'), #to load injected script
    url(r'^FnSaveSocialConfigDetails/$', 'myapp.SocialConfiguration.FnSaveSocialConfigDetails', name='FnSaveSocialConfigDetails'),
    url(r'^fnLoadBroadcastTypeTemplate/$', 'myapp.SocialConfiguration.fnLoadBroadcastTypeTemplate', name='fnLoadBroadcastTypeTemplate'),
    url(r'^FnLoadChannels/$', 'myapp.SocialConfiguration.FnLoadChannels', name='FnLoadChannels'),
    url(r'^FnActivateEvent/$', 'myapp.SocialConfiguration.FnActivateEvent'), #to load injected script
    ...
    url(r'^fnGetLinkedInAuthorisationCode/$', 'myapp.SocialConfiguration.fnGetLinkedInAuthorisationCode', name='FnLoadChannels'),
    url(r'^FnLoadDomainList/$', 'myapp.company-related-view.FnLoadDomainList'),
    url(r'^FnVerifyDomain/$', 'myapp.domain-verification.FnVerifyDomain'),
